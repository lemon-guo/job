...
<body>
  ...
  <nav>
   <ul>
    ...
    <div id="daddjl" >
    <form action="resume/resume_edit" enctype="multipart/form-data" method="post">
    <s:hidden name="resume.resumeid"/>
   ...
   <!--第一行-->
     ...
     <center style="margin: auto;"><button type="submit" class="dbutton" id="qr" name="qr" value="aaa">确认编辑</button></center>
    </form>
    <center style="margin: auto;margin-top:-20px;"><button class="dbutton" onclick="javascript:history.back();" value="返回到上一个页面">返回上一页</button></center>
