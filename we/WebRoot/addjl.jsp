...
<br>
    <div id="daddjl" align="center">
    <form action="resume/resume_add" enctype="multipart/form-data" method="post">
       <br><div class="step"><h1 id="wodejianli">我的简历</h1></div>
       <p class="t1"><strong>个人信息</strong></p>
       <table align="center">
        <tr>
            <td>姓名</td>
       ...
       <div class="t1" align="center"><p class="title t2"><strong>教育经历</strong> ( 请根据自身教育情况从高到低填写 ) </p></div>
       <table align="center">
        <tr>
            <td colspan="2">时间</td>
            <td colspan="2">单位</td>
        ...
        <tr>
            <td align="center" colspan="7"><b>联系方式</b></td>
        </tr>
        <tr>
            <td>联系电话</td>
       ...
       <table align="center">
        ...
        <tr>
            <td colspan="7" ><textarea cols="90%" rows="7" name="resume.sexpe"></textarea></td>
        </tr>
        <tr>
            <td colspan="7"  align="center"><b>科研成果</b></td>
        </tr>
        <tr>
            <td colspan="7" ><textarea cols="90%" rows="7" name="resume.sresearch"></textarea></td>
        </tr>
        <tr>
            <td colspan="7"  align="center"><b>个人能力（技能、特长或爱好）</b> </td>
        </tr>
        <tr>
            <td colspan="7" ><textarea cols="90%" rows="7" name="resume.sability"></textarea></td>
        </tr>
        <tr>
            <td colspan="7" align="center"><b>所获荣誉及奖项</b></td>
        </tr>
        <tr>
            <td colspan="7" ><textarea cols="90%" rows="7" name="resume.shonor"></textarea></td>
        </tr>
        <tr>
            <td colspan="7" align="center"><b>自我评价</b></td>
        </tr>
        <tr>
            <td colspan="7" ><textarea cols="90%" rows="7" name="resume.sevaluate"></textarea></td>
        </tr>
       </table>
     <center style="margin:5 auto;"><button type="submit" class="dbutton" id="qr" name="qr" value="aaa">确认添加</button></center>
    </form>
    <center style="margin:5 auto;margin-top:-20px;"><button class="dbutton" onclick="javascript:history.back();" value="返回到上一个页面">返回上一页</button></center>
