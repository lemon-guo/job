...
<body>
  ...
  <nav>
   <ul>
	...
	<table>
	  <tr> 
	  	<td colspan="2"> <p id="xiu1"><c:out value="${application.job.jobname}"></c:out></p> </td>
	    <td colspan="2"> <p id="xiu2"><c:out value="${application.job.salary}"></c:out>/月</p> </td>
	  </tr>
	   <tr><td>&nbsp;</td></tr>
	   <tr><td>&nbsp;</td></tr>
	  <tr>
  		<td colspan="4"><p id="xiu3"><c:out value="${application.job.companyname}"></c:out></p></td>
  	  </tr>	
  	  <tr>	
    	<td> <p id="xiu4">工作类别：<c:out value="${application.job.sorts}"></c:out></p> </td>
    	<td> <p id="xiu4">截止时间：<c:out value="${application.job.deadline}"></c:out></p> </td>
    </tr>
  	 <tr>
  	 ...
  	 <tr>
  	 	<td colspan="4"><p id="xiu3"><c:out value="${application.job.companyaddress}"></c:out></p> </td>
  	 </tr>
  	 <tr><td>&nbsp;</td></tr>
  	 <tr>
  	 ...
  	 <tr>
    	<td colspan="4"><p id="xiu3">电话：<c:out value="${application.job.companytelephone}"></c:out></p>
    	<p id="xiu3">邮箱：<c:out value="${application.job.companyemail}"></c:out></p></td>
     <tr>	
     <tr><td>&nbsp;</td></tr>
     <tr>
  	 ...
  	 <tr>
    	<td colspan="4"><p id="xiu3"><c:out value="${application.job.demand}"></c:out></p></td>
     </tr>
    </table>
    <br><br>
    <center><button class="dbutton" onclick="javascript:history.back();" value="返回">返回</button></center>
    <br><br>
	</section>
	<br><br><br><br>
</body>
